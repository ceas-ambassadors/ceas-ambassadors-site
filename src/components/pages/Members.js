        ...
        <Row className='page-content'>
            <Column>
                ...
                <div className='members--table'>
                    { items.map(member => (
                        <UserCard className='user-card' email={member.email} major={member.major} year={member.grad_year} coops={member.coops}>{member.first_name} {member.last_name}</UserCard>
                    ))}
